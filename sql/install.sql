...
CREATE INDEX nb_article_columns_status_approved		ON nb_article (columns, status, approved);
...
('隐藏', '系统文章', 'chinafreebsd-aboutus', '关于我们', 3, '');
